  ...
  useEffect(() => {
    fetch("https://attendify-tv8w.onrender.com")
      ...
      .then((json) => {
        ...
        // Parse today
        if (json.today) {
          const todayStr = json.today.split(" ")[0]; // take only dd-mm-yyyy
      ...
      >
        ...
        {data ? (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-6xl">
            {/* Left column with two stat cards stacked */}
            <div className="flex flex-col gap-6 h-full">
              ...
              <Card className="flex-1">
                ...
                <CardContent>
                  ...
                  <p>
                    Present: {data.attendance_snapshot.yesterday.present_count}
                  </p>
                  <p>
              ...
              <Card className="flex-1">
                ...
                <CardContent>
                  <p>
                    Present: {data.attendance_snapshot.weekly_avg.avg_present}
                  </p>
                  <p>
                    Marked:{" "}
            ...
            <Card className="h-full flex flex-col justify-center items-center">
              ...
              <CardContent className="flex-1 flex flex-col items-center justify-center">
                <Calendar
                  className="w-full max-w-lg" // wider calendar
                  modifiers={{
                  ...
                  modifiersClassNames={{
                    ...
                    today: "bg-sky-200 text-sky-800 rounded-md font-semibold",
                  }}
                />
